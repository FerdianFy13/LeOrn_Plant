...
class Cluster1PlantView extends StatelessWidget {
  Cluster1PlantView({Key key}) : super(key: key);

  ColorCoreController colorCoreController = ColorCoreController();
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: colorCoreController.white2,
