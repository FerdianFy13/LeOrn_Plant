...
class Monstera2ExploreView extends StatelessWidget {
  Monstera2ExploreView({Key key}) : super(key: key);
            ...
            child: Container(
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Center(
                    child: Text(
                      monsteraExploreController.btn1,
                      style: TextStyle(
                        color: Colors.white,
            ...
            child: Container(
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Center(
                    child: Text(
                      monsteraExploreController.btn2,
                      style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 20,
